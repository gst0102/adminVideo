<template>
  <div class="page">
    <div class="toolbar">
      <el-input v-model="filters.keyword" clearable placeholder="搜索求助标题 / 分类 / 说明" style="width: 320px" @keyup.enter="loadData" />
      <el-select v-model="filters.status" clearable placeholder="求助状态" style="width: 150px" @change="loadData">
    ...
    <div class="stats">
      ...
      <span>删除进行中的求助会先退回冻结积分，再从前台隐藏。</span>
    </div>

    <el-table v-loading="loading" :data="requests" border stripe empty-text="暂无求助记录">
      <el-table-column prop="id" label="求助ID" width="120" show-overflow-tooltip />
      ...
      <el-table-column prop="submissions_count" label="解答" width="80" align="center" />
